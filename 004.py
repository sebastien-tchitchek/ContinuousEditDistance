...
cinema_db_path = os.path.join(output_dir, "004.cdb")
...
for idx in range(2000, 2121):  
    ...
    filename = os.path.join(
        base_path,
        f"GEM_{idx}_0.0195_0_0_4_particles_{time_str}_mag(B).vtu",
    )
    reg_name = f"GEM_{idx}_0.0195_0_0_4_particles_{time_str}_mag(B).vtu"
...
UpdatePipeline(time=500.0, proxy=tTKBlockAggregator1)
